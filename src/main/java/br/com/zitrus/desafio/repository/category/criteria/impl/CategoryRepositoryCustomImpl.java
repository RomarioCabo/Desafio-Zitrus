...
public class CategoryRepositoryCustomImpl implements CategoryRepositoryCustom {
  ...
  @Override
  public Page<CategoryDto> filterCategory(
      CategoryFilter filter, Pageable pageable, Direction direction) {
    ...
    if (filter.getId() != null) {
      predicates.add(criteriaBuilder.equal(root.get("idCategory"), filter.getId()));
    }
